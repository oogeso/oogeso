...
optimized_result = core.optimize_power_system(nodes=power_network.nodes, edges=power_network.edges, constraints=power_network.constraints)

# Serialize results and dump to file
optimized_result_serialized = dto.serialize_power_network_optimization_result(optimized_result)
io.file_io.dump_to_file(json_data=optimized_result_serialized, filename='my_output_filename.json')
