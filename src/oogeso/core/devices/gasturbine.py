...
#                print("lhs=",lhs,"rhs=",rhs)
    ...
    def defineConstraints(self):
        ...
        setattr(self.pyomo_model,'constr_{}_{}'.format(self.dev_id,'startstop'),
        ...
        setattr(self.pyomo_model,'constr_{}_{}'.format(self.dev_id,'startdelay'),
    ...
    def compute_CO2(self,timesteps):
        ...
        thisCO2 = sum(model.varDeviceFlow[self.dev_id,'gas','in',t]
    ...
    def compute_startup_costs(self,timesteps):
        ...
        if 'startupCost' in self.params:
            ...
            thisCost = sum(model.varDeviceStarting[self.dev_id,t]
        ...
        if 'shutdownCost' in self.params:
            ...
            thisCost = sum(model.varDeviceStopping[self.dev_id,t]
