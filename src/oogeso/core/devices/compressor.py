...
class Compressor_el(Device):
    ...
    def _rules(self, model, t, i):
        ...
        if i == 1:
            ...
            rhs = compute_compressor_demand(
                model, dev, param_dev, param_node, param_gas, linear=True, t=t
            )
            return lhs == rhs
    ...
    def defineConstraints(self):
        ...
        setattr(
            self.pyomo_model,
            "constr_{}_{}".format(self.dev_id, "compr"),
...
class Compressor_gas(Device):
    ...
    def defineConstraints(self):
        ...
        # add constraint to model:
        setattr(self.pyomo_model, "constr_{}_{}".format(self.dev_id, "compr"), constr)
