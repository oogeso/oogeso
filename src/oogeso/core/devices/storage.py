...
class Storage_el(_StorageDevice):
    ...
    def defineConstraints(self):
        ...
        constr = pyo.Constraint(self.pyomo_model.setHorizon,pyo.RangeSet(1,9),
              rule=self._rules)
    ...
    def getMaxP(self,t):
        ...
        maxValue = (model.varDeviceStoragePmax[self.dev_id,t]
